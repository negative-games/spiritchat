...
public class SpiritChatConfig {
    ...
    public static class Format {
        ...
        @Comment({
                ...
                "SpiritChat checks the player's inherited LuckPerms groups by weight,",
                "from highest to lowest, and uses the first group here with a matching format.",
                "If 'default' is winning over another group, raise the other group's LuckPerms weight",
                "or remove the default group from that player's inherited groups.",
                " ",
                "Placeholders:",
                "  %display-name% - The player's display-name.",
                "  %username% - The player's username.",
